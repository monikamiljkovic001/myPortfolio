  ...
  skills = [
    {
      name: 'HTML',
      proficiency: 90,
      color: 'linear-gradient(to right, #ff0080, #ff00ff)',
    },
    {
      name: 'CSS',
      proficiency: 90,
      color: 'linear-gradient(to right, #00ff99, #00cc66)',
    },
    {
      name: 'JavaScript',
      proficiency: 50,
      color: 'linear-gradient(to right, #ffff00, #ffcc00)',
    },
    {
      name: 'Angular',
      proficiency: 25,
      color: 'linear-gradient(to right, #ff4b5c, #ff2a68)',
    },
    {
      name: 'Tailwind',
      proficiency: 70,
      color: 'linear-gradient(to right, #00f2f2, #0099ff)',
    },
    {
      name: 'Bootstrap',
      proficiency: 70,
      color: 'linear-gradient(to right, #ff31f2, #ff9100)',
    },
  ];
